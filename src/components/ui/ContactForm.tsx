...
export function ContactForm({ locale }: { locale: string }) {
  ...
  const inputClass =
    'w-full bg-[#1A1A1A] border border-white/10 rounded-md px-4 py-3 text-[#F0F0F0] placeholder-[#888888] text-sm focus:outline-none focus:ring-2 focus:ring-[#8B0000] focus:border-transparent transition-all duration-200'
  const fontFamily =
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5" style={{ fontFamily }}>
      ...
      <div className="flex flex-col gap-2">
        <label className="text-[12px] tracking-[0.15em] uppercase text-[#888888]" htmlFor="contact-name">
      ...
      {/* Email */}
      <div className="flex flex-col gap-2">
        <label className="text-[12px] tracking-[0.15em] uppercase text-[#888888]" htmlFor="contact-email">
      ...
      {/* Phone */}
      <div className="flex flex-col gap-2">
        <label className="text-[12px] tracking-[0.15em] uppercase text-[#888888]" htmlFor="contact-phone">
          {t('phone')}
        </label>
        <input
          id="contact-phone"
      ...
      <div className="flex flex-col gap-3">
        <p className="text-[12px] tracking-[0.15em] uppercase text-[#888888]">{t('services')}</p>
      ...
      {/* Genre */}
      <div className="flex flex-col gap-2">
        <label className="text-[12px] tracking-[0.15em] uppercase text-[#888888]" htmlFor="contact-genre">
          {t('genre')}
        </label>
        <input
          id="contact-genre"
      ...
      {/* Message */}
      <div className="flex flex-col gap-2">
        <label className="text-[12px] tracking-[0.15em] uppercase text-[#888888]" htmlFor="contact-message">
